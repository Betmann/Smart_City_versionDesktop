    ...
    return (
        <div className={estilos.conteiner}>
            ...
            <form className={estilos.formulario} onSubmit={handleSubmit(obterDadosFormulario)}>
                ...
                <div className={estilos.coordenadas}>
                    <input {...register('latitude')} className={estilos.campoCoordenada} placeholder="Latitude" />
                    <input {...register('longitude')} className={estilos.campoCoordenada} placeholder="Longitude" />
                </div>
